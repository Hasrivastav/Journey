    ...
    <div id="about" className="about">
      ...
      <div className="card_container">
        <div className="card">
          ...
          <ul className="sci">
            <li style={{ "--i": 2 }}>
              <a href="https://github.com/Hasrivastav">
                <FaGithub style={{ color: "black", fontStyle: "none" }} />
              </a>
            </li>
            <li style={{ "--i": 3 }}>
              <a href="https://www.linkedin.com/in/harsh-srivastav2024/">
                <FaLinkedin style={{ color: "black", fontStyle: "none" }} />
              </a>
            </li>
          </ul>
        </div>
        <div className="card">
          <div className="content">
            ...
            <div className="cardContent">
              ...
              <a href="https://cryptobuddy.vercel.app/">
                <h3>Cryptobuddy</h3>
              </a>
